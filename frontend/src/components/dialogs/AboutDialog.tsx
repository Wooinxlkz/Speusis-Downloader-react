...
/**
 * Intentionally its OWN simple content, separate from Settings -> About's
 * richer AboutContent - a past version merged the two, which changed this
 * header dialog's content without being asked to. Keeping them distinct
 * again on purpose.
 */
