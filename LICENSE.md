# Speusis Downloader — Software License Agreement

**Version 2.1 — supersedes and replaces `src-tauri/license.txt` wherever the two conflict.**
...
License Agreement is the only license under which any use is authorized.
